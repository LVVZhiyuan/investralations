...
def parse_pdf(path,file):
    ...
    return {"file":file,"code":code,"name":name,"tme_head":tme_head,"tme":tme,"pss_head":pss_head,"pss":pss,"ty_head":ty_head,"ty":ty,"pre_ty":pre_ty},psslist
    
if __name__ == '__main__':  
    path = u'D:\\wjh\\2015\\'
    file = u'2015-12-11-常山药业：2015年12月10日投资者关系活动记录表.PDF'
    extractdic,namelist = parse_pdf(path,file)
    for i in extractdic:
